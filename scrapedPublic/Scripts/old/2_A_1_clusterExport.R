...
dir.create("./Data/2_clusterExport/poolSHP")

dir.create("./Data/2_clusterExport/sentinelSHP")

dir.create("./Data/2_clusterExport/birdSHP")
...
write_sf(poolShp, "./Data/2_clusterExport/poolSHP/poolSHP.shp")


write_csv(sentKey, "./Data/2_clusterExport/sentinelClusterIDKey.csv")
write_sf(sentShp, "./Data/2_clusterExport/sentinelSHP/sentinelSHP.shp")


write_csv(birdKey, "./Data/2_clusterExport/birdClusterIDKey.csv")
write_sf(birdShp, "./Data/2_clusterExport/birdSHP/birdSHP.shp")
